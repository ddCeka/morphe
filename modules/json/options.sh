...
editOptions() {
    local OPTIONS_JSON OPTIONS_LIST SELECTED_OPTION CURRENT_VALUE TYPE DESCRIPTION VALUE ALLOWED_VALUES NEW_VALUE EXIT_CODE TEMP_FILE UPDATED_OPTIONS UPDATED_PATCHES
    ...
    while true; do
        ...
        unset CURRENT_VALUE TYPE DESCRIPTION VALUES ALLOWED_VALUES NEW_VALUE UPDATED_OPTIONS
    done
